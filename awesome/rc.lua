...
tags = {
   names = { "Webs ", "Chat ", "Terms ", "Sys ", "News ", "Devs ", "Rand " },
   layout = { layouts[1], layouts[6], layouts[6], layouts[6], layouts[6], layouts[6], layouts[1] }
}
...
netwidget = lain.widgets.net({
    settings = function()
        widget:set_markup(markup("#4d801e", " " .. net_now.received)
                          .. " " ..
                          markup("#2d6b84", " " .. net_now.sent .. " "))
    end
})
